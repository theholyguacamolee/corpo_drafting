...
export function usePartnershipState() {
  ...
  return {
    ...
    baseContribs: baseContributions,
    setBaseContribs: setBaseContributions,
    baseAmountWords, setBaseAmountWords,
    baseTotalCapWords: baseAmountWords,
    setBaseTotalCapWords: setBaseAmountWords,
    baseAmountNum, setBaseAmountNum,
    baseTotalCapAmt: baseAmountNum,
    setBaseTotalCapAmt: setBaseAmountNum,
